<%-- 
    Document   : accept_appointment
    Created on : 10 Jun 2025, 7:25:02 am
...
<%
    ...
    if (appointmentId != null && !appointmentId.isEmpty()) {
        ...
        try {
            ...
            if (rowsAffected > 0) {
                out.println("<script>alert('Appointment Approved.'); window.location='manage_appointment.jsp';</script>");
            } else {
                out.println("<script>alert('Failed to approve appointment. It may no longer be pending.'); window.location='manage_appointment.jsp';</script>");
            }
